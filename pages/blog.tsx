...
const howToSteps = [
  { name: 'Open FitCircle', text: 'Go to the workspace and enter the inputs FitCircle asks for.' },
  { name: 'Generate the draft', text: 'Run FitCircle to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "FitCircle keeps a fitness community active with AI-generated 30-day challenges, daily discussion prompts, weekly…"
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">FitCircle keeps a fitness community active with AI-generated 30-day challenges, daily discussion prompts, weekly…</p>
