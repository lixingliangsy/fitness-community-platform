  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://fitness-community-platform.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is FitCircle?", "acceptedAnswer": {"@type": "Answer", "text": "FitCircle is a fitness community platform that uses AI to generate challenges, discussion prompts, newsletters, and member spotlights."}}, {"@type": "Question", "name": "What does it generate?", "acceptedAnswer": {"@type": "Answer", "text": "A 30-day challenge generator, daily discussion prompts, weekly newsletter drafts, and member spotlight ideas."}}, {"@type": "Question", "name": "Do I still write posts?", "acceptedAnswer": {"@type": "Answer", "text": "It drafts the content; you review and post, which removes the daily blank-page friction."}}, {"@type": "Question", "name": "Who should use FitCircle?", "acceptedAnswer": {"@type": "Answer", "text": "Community managers and fitness creators who want consistent engagement without hand-writing every post."}}, {"@type": "Question", "name": "How does it help growth?", "acceptedAnswer": {"@type": "Answer", "text": "Steady prompts and member spotlights drive the engagement and social proof that grow a community."}}, {"@type": "Question", "name": "Is it only for fitness?", "acceptedAnswer": {"@type": "Answer", "text": "It is built for fitness communities specifically, with challenge and spotlight flows tuned to that audience."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">FitCircle - definition</h2>
...
<section id="features" className="py-20">
        ...
        <section id="testimonials" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4">Loved by operators who ship</h2>
            <p className="text-center text-slate-500 mb-10">
              Real stories coming soon. We don&apos;t publish invented quotes — add yours after a trial.
            </p>
            <div className="grid md:grid-cols-3 gap-5">
              {[
                ['[Customer]', 'Title at [Company]', '"[Placeholder — replace with a real, attributed quote once a user agrees to be featured.]"'],
                ['[Customer]', 'Title at [Company]', '"[Placeholder — replace with a real, attributed quote once a user agrees to be featured.]"'],
                ['[Customer]', 'Title at [Company]', '"[Placeholder — replace with a real, attributed quote once a user agrees to be featured.]"'],
              ].map(([nm, role, q], i) => (
                <div key={i} className="bg-white rounded-2xl border border-slate-200 p-6">
                  <div className="text-amber-400 mb-3">★★★★★</div>
                  <p className="text-slate-400 mb-4 italic">{q}</p>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-slate-200 text-slate-400 grid place-items-center font-bold">?</div>
                    <div>
                      <div className="font-bold text-sm text-slate-400">{nm}</div>
