 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="fitness-community-platform" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "fitness-community-platform";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "fitness-community-platform") + "_chat_session";
