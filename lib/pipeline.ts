...
export const PIPELINE_ID = 'fitness-community-platform-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Community niche & cadence",
  process: "Step 2/3 · Draft challenge & prompts",
  output: "Step 3/3 · Newsletter + spotlight ideas",
}
